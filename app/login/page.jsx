...
// IMPORT supabase DARI UTILS:
import { supabase } from '@/utils/supabase'; // Sesuaikan path ini dengan letak folder utils Anda

export default function LoginPage() {
  
  // Fungsi untuk memicu Login Google
  ...
  return (
    <div className="login-container">
      ...
      <div className="login-card">
        ...
        {/* Event onClick memanggil fungsi handleGoogleLogin */}
